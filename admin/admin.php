    ...
    <div class="col-xs-10">
      <div class="tab-content">
        ...
        <div id="barang" class="tab-pane fade">
          <h3 class="table-title"><strong>Tabel Penjualan</strong></h3>
              ...
              <div class="modal fade" id="form-barang" role="dialog">
                <div class="modal-content" style="width:40vw;margin-top:10vh; margin-left:30vw">
                  <div class="modal-header">
                    ...
                    <h4 style="margin-left:150px"><strong>Tambahkan Stok</strong></h4>
                  </div>
                  <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label for="ukuran">Ukuran Ikan</label>
                        <select class="form-control" id="ukuran" name="ukuran">
                          <option value="S 2.5-3cm">S 2.5-3cm</option>
                          <option value="M 5.5-7cm">M 5.5-7cm</option>
                          <option value="L 8-11cm">L 8-11cm</option>
                          <option value="XL 12.5-14cm">XL 12.5-14cm</option>
                        </select>
                      </div>
          ...
          <div class="container">
            ...
            <ul class="nav nav-pills" style="margin-left: 15vw;">
              <li class="dropdown active item-kategori">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Jenis Ikan<span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a data-toggle="tab" href="#tabel-pria">ikan laut</a></li>
                  <li><a data-toggle="tab" href="#tabel-wanita">ikan tawar</a></li>                     
                </ul>
              </li>
