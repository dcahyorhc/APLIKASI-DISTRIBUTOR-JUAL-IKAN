  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:10vw; height:9vh; padding-top:0px;" alt="Brand" src="asset/img/merek.jpg">
      </a>
    </div>
      ...
      $conn = mysqli_connect('localhost', 'root', '', 'batiku');
        if(isset($_SESSION['idUser'])){
          ...
          <a href="admin/login.php"  >                
            <button style="color:#7986cb;
                      background-color: white;" class="btn navbar-btn" id="btn-login"><b>Admin</b></button>
          </a>
          </div>
          <?php }
      ?>
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:14vw; height:7vh; padding-top:2vh;" alt="Brand" src="asset/img/logo1.png"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Jenis Ikan<span class="caret" style="margin-left:10px"></span></a>
            <ul class="dropdown-menu">
              <li><a data-toggle="pill" href="#pria">ikan laut</a></li>
              <li><a data-toggle="pill" href="#wanita">ikan tawar</a></li>
            </ul>

        </li>
        <li><a data-toggle="pill" href="#couple"></a></li>
        <li><a data-toggle="pill" href="#anak" ></a></li>
        <li><a data-toggle="pill" href="#sarimbit"></a></li>
      </ul>
    </div>
  </div>
</div>
