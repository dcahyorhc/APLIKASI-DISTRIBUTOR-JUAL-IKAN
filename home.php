...
<div class="container-fluid" id="isi" >
  ...
  <div class="row">
    <div class="col-xs-2 col-xs-offset-5" id="produk-laris">
      <h3 style="font-family: Blacksword; font-size:2.2em;"><strong>My Ikan</strong></h3>
      
    </div>
  </div>
  <center><h3 style="font-family: Blacksword; font-size:2.5em;"><strong>Selamat Datang Di Website MY IKAN</strong></h3></center>
  ...
  <div class="container" id="produk">
    ...
    <div id="pria" class="tab-pane fade">
      ...
      <?php 
        ...
        $querypria = "SELECT * FROM tabel_produk WHERE kategori='ikan laut' LIMIT 0,4";
    ...
    <!-- wanita -->
      ...
      <?php 
        ...
        $queryWanita = "SELECT * FROM tabel_produk WHERE kategori='ikan tawar' LIMIT 0,4";
