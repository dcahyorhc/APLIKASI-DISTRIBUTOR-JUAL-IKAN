<?php 
  ...
  if($query){
    echo '
      <script>
      alert("Terima Kasih sudah Berbelanja, Silahkan Tranfer ke Rekening Mandiri 110-121-122-1-0 an. Nanda Hendrawan. Barang anda akan segera kami kirim setelah pembayaran dilakukan. Semoga anda nyaman dengan layanan kami.!");
